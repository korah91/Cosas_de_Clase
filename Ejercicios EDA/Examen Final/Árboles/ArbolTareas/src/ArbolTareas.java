public class ArbolTareas {
	...
	private int coste(String idTarea, BinaryTreeNode a){
		...
		{
			if(a.element.id.equalsIgnoreCase(idTarea))
			{
				suma = a.element.coste;
				if(a.left != null)
				{
					suma = suma + coste(a.left);
				}
				if(a.right != null)
				{
					suma = suma + coste(a.right);
				}
			}
			else
			{
				...
				if(a.left != null)
				{
					suma = suma + coste(idTarea, a.left);
				}
				if(a.right != null)
				{
					suma = suma + coste(idTarea, a.right);
				}
			}
		}
		return suma;
	...
	private int coste(BinaryTreeNode a) {
		if (a == null) return 0;
		// COMPLETAR CÓDIGO
		else
		{
			int suma = a.element.coste;
			if(a.left != null)
			{
				suma = suma + coste(a.left);
			}
